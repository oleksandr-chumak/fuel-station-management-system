...
-- changeset oleksandr-chumak:005-create-fuel-station-managers-table
...
(
    ...
    CONSTRAINT fuel_station_managers_manager_id_fk FOREIGN KEY (manager_id) REFERENCES managers (credentials_id) ON DELETE CASCADE
);
