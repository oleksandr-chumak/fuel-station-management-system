...
public class CreateFuelStationRequest {
    ...
    @Pattern(regexp = "^[\\p{L}0-9\\-/]+$", message = "Building number can only contain letters, numbers, hyphens, and slashes")
    private String buildingNumber;

    @NotBlank(message = "City must not be blank")
    @Size(min = 2, max = 50, message = "City must be between 2 and 50 characters")
    @Pattern(regexp = "^[\\p{L}\\s\\-']+$", message = "City can only contain letters, spaces, hyphens, and apostrophes")
    private String city;
